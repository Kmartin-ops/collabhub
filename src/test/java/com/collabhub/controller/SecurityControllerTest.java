...
@Import({ProjectMapperImpl.class, SecurityConfig.class,
        JwtAuthFilter.class, UserDetailsServiceImpl.class})
...
class SecurityControllerTest {
    ...
    @MockBean TaskAuthService taskAuthService;
    @MockBean com.collabhub.security.JwtService jwtService;
    @MockBean com.collabhub.repository.UserRepository userRepository;
    ...
    class CreateProject {
        ...
        void managerCanCreate() throws Exception {
            ...
            when(userService.getByEmail(any())).thenReturn(
                    new com.collabhub.domain.User("Alice", "alice@test.com", "MANAGER"));
    ...
    class DeleteProject {
        ...
        void managerCanDelete() throws Exception {
            ...
            mockMvc.perform(delete("/api/projects/" + PROJECT_ID))
